...
<html>
<head>
	<title><?php foreach($artikel as $d){ echo $d->judul; } ?></title>
	...
	<div class="breadcrumb_wrapper" style="margin-top: 100px;">
			...
			<div class="row justify-content-center">
				<div class="col-md-4">
					<div class="breadcrumb_inner">
						<h3><?php foreach($artikel as $d){ echo $d->judul;} ?></h3>
					</div>
				</div>
			</div>
		</div>
		<div class="breadcrumb_block" style="background: #E52929">
			<ul>
				...
				<li><?php foreach($artikel as $d){ echo $d->judul; } ?></li>
			</ul>
		</div>
	</div>
					...
					<div class="blog_left_section">
						<div class="blog_section">
							<div class="agri_blog_image">
								<img src="<?php echo base_url() ?>assets/upload/artikel/<?php foreach($artikel as $d){ echo $d->foto; } ?>" style="height: 410px; object-fit: contain;" alt="image">
                                <span class="agri_blog_date"><?php foreach($artikel as $d){ echo $d->tanggal; } ?></span>
							</div>
							<div class="agri_blog_content">
								<h3><?php foreach($artikel as $d){ echo $d->judul; } ?></h3>
								<p class="mt-3"><?php foreach($artikel as $d){ echo $d->desc; } ?></p>
							</div>
						</div>
					</div>
				</div>
